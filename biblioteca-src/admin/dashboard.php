                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <form action="dashboard.php" method="get">
                                            ...
                                            <button type="submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Permite habilitar a vecinos inscritos desde la página">Habilitar</button>
                                        </form>
                                        </td>
                                    </tr>
                                <?php } ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        data-toggle="tooltip" data-placement="top" title="Permite renovar mebresía de vecinos que les haya expirado">Renovar membresía</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                                ...
                                foreach ($vecinos as $vecino) {
                                    if($vecino['fecha_vencimiento'] < date('Y-m-d')){
                                        ...
                                        <tr>
                                            ...
                                            echo date("d-m-Y", strtotime($vecino['fecha_vencimiento']));
                                            ?></td>
                                            <td><a type="button" href="dashboard.php?id=<?php echo $vecino['id_usuario']; ?> & button=deshabilitar" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Permite deshabilitar a vecino que expiró su fecha de membresía">Deshabilitar vecino</a></td>
                                        </tr>
                                <?php }
                                }?>
